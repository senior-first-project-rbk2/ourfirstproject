...
function Cart({ setTotal }) {
  ...
  const getCartByUser = () => {
    ...
    axios
      .get(`http://localhost:5000/cart/getcartbyuser/${userID}`)
      .then((res) => {
    ...
    return (
      <div className="icon__shopping__cart">
        ...
        <div className="icon__details">
          ...
          <span>
            You have no items in your shopping cart, let's add some items you
            like.
          </span>
        </div>
      </div>
    ...
    return (
      <div className="display-products-cart">
        ...
        <div className="buy-bouton">
          <button
            onClick={() => {
              navigate("/useradress"), setTotal(totalSum);
            }}
          >
            Buy
          </button>
